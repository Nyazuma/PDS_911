...
public enum MessageType {
	...
	REPORTRFID, REPORTCALL, REPORTSMOKE, REPORTMOTION, REPORTTEMPERATURE, REPORTHYGRO, REPORTOPENING, DATE,
	// Request from the GUI without a specific class
	NUMBEROBJECT, PING, NUMBEROBJECTADDED, NUMBEROBJECTDELETED, NUMBEROBJECTUPDATED, 
